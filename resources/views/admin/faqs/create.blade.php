                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route("admin.faqs.store") }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    @endif
                                    <span class="help-block">Question Required *</span>
                                </div>
                                <div class="form-group">
                                    <label class="required" for="question">Answer</label>
                                    <textarea class="form-control {{ $errors->has('answer') ? 'is-invalid' : '' }}" type="text" name="answer" id="answer" required></textarea>
                                    @if($errors->has('answer'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('answer') }}
                                        </div>
                                    @endif
                                    <span class="help-block">Answer Required *</span>
                                </div>
                                <div class="form-group">
