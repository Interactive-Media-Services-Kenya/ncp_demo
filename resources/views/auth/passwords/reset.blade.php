            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-6">
                    <div class="login-wrap p-0">
                        <h3 class="mb-4 text-center">Enter A new Password</h3>
                        <form action="{{ route('password.update') }}" class="signin-form" method="POST">
                            @csrf
                            <div class="form-group">
                                <input id="email" type="text" name="email"
                                    class="form-control @error('email') is-invalid @enderror"
                                    placeholder="somebody@example.com" required value="{{ $email ?? old('email') }}">
                            ...
                            <div class="form-group">
                                <button type="submit" class="form-control btn btn-success submit px-3">Change Password</button>
                            </div>
